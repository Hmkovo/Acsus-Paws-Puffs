/**
 * 删除好友消息渲染器
 * @module phone/messages/message-types/friend-deleted-message
 * 
 * @description
 * 渲染"删除好友"系统提示消息（居中显示，类似添加好友）
 */
 ...
 * 
 * @example
 * const bubble = renderFriendDeletedMessage({
 *   content: '{{user}}删除了你为好友',
 *   time: 1699999999
 * });
 */
export function renderFriendDeletedMessage(message) {
